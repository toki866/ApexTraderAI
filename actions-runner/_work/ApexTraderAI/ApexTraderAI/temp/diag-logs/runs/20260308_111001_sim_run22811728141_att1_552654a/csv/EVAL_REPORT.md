...
- output_root: `C:\work\apex_work\runs\gh22811728141_att1_sim_20260308_110023_552654a\output`
- mode: `sim`
- symbol: `SOXL`
- overall_status: **BAD**
...
|---|---|---:|---:|---:|---:|---|
| stepB_pred_close_mamba_SOXL.csv | Pred_Close_MAMBA | 0.9364 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h01 | 0.9364 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h01 | 0.9364 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h05 | 0.9345 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h05 | 0.9345 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h10 | 0.9320 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h10 | 0.9320 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h20 | 0.9270 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h20 | 0.9270 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC | 0.9364 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC | 0.9364 | 0.0000 | NA | NA | WARN |
| stepB_pred_time_all_SOXL.csv | Pred_Close_MAMBA | 0.0000 | 0.0000 | NA | NA | BAD |
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\gh22811728141_att1_sim_20260308_110023_552654a\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 63,
    ...
    "rows": [
      {
        ...
        "non_null_ratio": 0.9364448857994042,
      ...
      },
      {
        ...
        "non_null_ratio": 0.9344587884806356,
        "first_valid_date": "2014-07-15",
        "coverage_ratio_over_test": 0.0,
        "mae": null,
        "corr": null,
        "status": "WARN"
      ...
      },
      {
        ...
        "non_null_ratio": 0.9319761668321748,
        "first_valid_date": "2014-07-22",
        "coverage_ratio_over_test": 0.0,
        "mae": null,
        "corr": null,
        "status": "WARN"
      ...
      },
      {
        ...
        "non_null_ratio": 0.9270109235352533,
        "first_valid_date": "2014-08-05",
        "coverage_ratio_over_test": 0.0,
        "mae": null,
        "corr": null,
        "status": "WARN"
  ...
  "dprime": {
    ...
    "details": {
      ...
      "searched": [
        "C:\\work\\apex_work\\runs\\gh22811728141_att1_sim_20260308_110023_552654a\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\gh22811728141_att1_sim_20260308_110023_552654a\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\gh22811728141_att1_sim_20260308_110023_552654a\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
