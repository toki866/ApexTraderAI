...
- output_root: `C:\work\apex_work\runs\gh22823895124_att1_sim_20260309_001922_f2091bb\output`
- mode: `sim`
- symbol: `SOXL`
- overall_status: **WARN**
...
|---|---|---:|---:|---:|---:|---|
| stepB_pred_close_mamba_SOXL.csv | Pred_Close_MAMBA | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h01 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h01 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h05 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h05 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h10 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h10 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h20 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h20 | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC | 1.0000 | 0.0000 | NA | NA | WARN |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC | 1.0000 | 0.0000 | NA | NA | WARN |
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\gh22823895124_att1_sim_20260309_001922_f2091bb\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 63,
  ...
  "dprime": {
    ...
    "details": {
      ...
      "embeddings_files": [],
      "searched": [
        "C:\\work\\apex_work\\runs\\gh22823895124_att1_sim_20260309_001922_f2091bb\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\gh22823895124_att1_sim_20260309_001922_f2091bb\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\gh22823895124_att1_sim_20260309_001922_f2091bb\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
