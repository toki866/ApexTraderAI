...
## DPrime diagnostics
- status: **WARN**
- summary: DPrimeCluster=WARN (missing cluster embeddings/state/input); DPrimeRL=OK (RL state files found under stepDprime/sim); failure_reason=NameError("name 'cluster_out' is not defined")
...
```json
{
  ...
  "dprime": {
    ...
    "details": {
      ...
      "failure_reason": "NameError(\"name 'cluster_out' is not defined\")",
      "traceback_glob": [
