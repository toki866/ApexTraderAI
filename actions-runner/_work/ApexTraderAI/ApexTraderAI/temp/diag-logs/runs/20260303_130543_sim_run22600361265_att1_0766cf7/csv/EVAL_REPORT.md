...
- output_root: `C:\work\apex_work\runs\gh22600361265_att1_sim_20260303_082137_0766cf7\output`
- mode: `sim`
- symbol: `SOXL`
- overall_status: **OK**
...
|---|---:|---:|---:|---:|---:|---:|---|---|
| stepF_equity_marl_SOXL.csv | 63 | 1.3187 | -0.3183 | 0.0063 | 0.0586 | 1.7036 | Split missing: evaluated all rows as test | OK |
...
- [scatter_stepE_dd_vs_ret.png](./scatter_stepE_dd_vs_ret.png)
  - note: StepF_vs_best_StepE: StepF(1.3187) は best StepE(1.9352) に負けてる
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\gh22600361265_att1_sim_20260303_082137_0766cf7\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 63,
  ...
  "dprime": {
    ...
    "details": {
      ...
      "searched": [
        "C:\\work\\apex_work\\runs\\gh22600361265_att1_sim_20260303_082137_0766cf7\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\gh22600361265_att1_sim_20260303_082137_0766cf7\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\gh22600361265_att1_sim_20260303_082137_0766cf7\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
    ...
    "rows": [
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.318696155208039,
        "max_dd": -0.3182626883257095,
        "mean_ret": 0.0062845065270781195,
        "std_ret": 0.05855950708101801,
        "sharpe": 1.7036251374595957,
        "status": "OK",
  ...
  "plots": {
    ...
    "notes": [
      "StepF_vs_best_StepE: StepF(1.3187) は best StepE(1.9352) に負けてる"
    ]
  }
}
```
