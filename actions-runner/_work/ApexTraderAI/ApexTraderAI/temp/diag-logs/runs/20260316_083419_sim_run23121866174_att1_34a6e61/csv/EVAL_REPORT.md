...
## DPrime diagnostics
- status: **WARN**
- summary: DPrimeCluster=WARN (missing cluster embeddings/state/input); DPrimeRL=WARN (missing RL state files); failure_reason=TICCUnavailableError("TICC function backend invocation failed backend=fast_ticc entrypoint=fast_ticc.ticc_labels signature=(data_series: numpy.ndarray, window_size: int = 10, num_clusters: int = 5, sparsity_weight: Union[float, numpy.ndarray] = 0.11, label_switching_cost: Union[float, numpy.ndarray] = 400, iteration_limit: int = 1000, min_meaningful_covariance: float = 0, num_processors: int = 1, min_cluster_size: int = 20, biased_covariance: bool = False) -> fast_ticc.containers.results.SingleDataSeriesResult passed_positional=0 passed_keyword_names=['data_series', 'iteration_limit', 'label_switching_cost', 'num_clusters', 'sparsity_weight', 'window_size'] error=LinAlgError: Eigenvalues did not converge")
...
```json
{
  ...
  "dprime": {
    ...
    "details": {
      ...
      "failure_reason": "TICCUnavailableError(\"TICC function backend invocation failed backend=fast_ticc entrypoint=fast_ticc.ticc_labels signature=(data_series: numpy.ndarray, window_size: int = 10, num_clusters: int = 5, sparsity_weight: Union[float, numpy.ndarray] = 0.11, label_switching_cost: Union[float, numpy.ndarray] = 400, iteration_limit: int = 1000, min_meaningful_covariance: float = 0, num_processors: int = 1, min_cluster_size: int = 20, biased_covariance: bool = False) -> fast_ticc.containers.results.SingleDataSeriesResult passed_positional=0 passed_keyword_names=['data_series', 'iteration_limit', 'label_switching_cost', 'num_clusters', 'sparsity_weight', 'window_size'] error=LinAlgError: Eigenvalues did not converge\")",
      "traceback_glob": [
