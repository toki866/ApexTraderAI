...
|---|---|---:|---:|---:|---:|---|
| stepB_pred_close_mamba_SOXL.csv | Pred_Close_MAMBA | 0.9384 | 1.0000 | 4.3516 | 0.8947 | OK |
| stepB_pred_time_all_SOXL.csv | Pred_Close_MAMBA | 0.9384 | 1.0000 | 4.3516 | 0.8947 | OK |

## StepE table
| agent | file | test_days | equity_multiple | max_dd | mean_ret | std_ret | sharpe | note | status |
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| dprime_bnf_h01 | stepE_daily_log_dprime_bnf_h01_SOXL.csv | 63 | 1.5157 | -0.2754 | 0.0084 | 0.0747 | 1.7853 |  | OK |
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\gh22765665251_att1_sim_20260306_223344_3560d51\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 63,
    ...
    "rows": [
      {
        ...
        "mae": 4.3516000414651534,
        "corr": 0.8946696030426183,
        "status": "OK"
      },
      {
  ...
  "dprime": {
    ...
    "details": {
      ...
      "searched": [
        "C:\\work\\apex_work\\runs\\gh22765665251_att1_sim_20260306_223344_3560d51\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\gh22765665251_att1_sim_20260306_223344_3560d51\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\gh22765665251_att1_sim_20260306_223344_3560d51\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
    ...
    "rows": [
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.515669468258472,
        "max_dd": -0.2754265220953953,
        "mean_ret": 0.00839657831703592,
        "std_ret": 0.0746600867430533,
        "sharpe": 1.7853119968003228,
        "status": "OK"
      }
    ]
  },
