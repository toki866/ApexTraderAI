...
## DPrime diagnostics
- status: **WARN**
- summary: DPrimeCluster=WARN (missing cluster embeddings/state/input); DPrimeRL=WARN (missing RL state files); failure_reason=TICCUnavailableError("No usable TICC backend found. Install `fast-ticc` (primary) or `TICC_solver` (legacy). fast_ticc_error=ImportError: cannot import name 'TICC' from 'fast_ticc' (/home/becky/miniforge3/envs/mamba_cuda/lib/python3.10/site-packages/fast_ticc/__init__.py); ticc_solver_error=ModuleNotFoundError: No module named 'TICC_solver'")
...
```json
{
  ...
  "dprime": {
    ...
    "details": {
      ...
      "failure_reason": "TICCUnavailableError(\"No usable TICC backend found. Install `fast-ticc` (primary) or `TICC_solver` (legacy). fast_ticc_error=ImportError: cannot import name 'TICC' from 'fast_ticc' (/home/becky/miniforge3/envs/mamba_cuda/lib/python3.10/site-packages/fast_ticc/__init__.py); ticc_solver_error=ModuleNotFoundError: No module named 'TICC_solver'\")",
      "traceback_glob": [
