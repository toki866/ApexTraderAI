...
## DPrime diagnostics
- status: **WARN**
- summary: DPrimeCluster=WARN (missing cluster embeddings/state/input); DPrimeRL=WARN (missing RL state files); failure_reason=ValueError('cannot insert cluster_id_raw20, already exists')
...
```json
{
  ...
  "dprime": {
    ...
    "details": {
      ...
      "failure_reason": "ValueError('cannot insert cluster_id_raw20, already exists')",
      "traceback_glob": [
