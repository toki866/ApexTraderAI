...
- output_root: `C:\work\apex_work\runs\gh22617360504_att1_sim_20260303_184740_01c3594\output`
- mode: `sim`
- symbol: `SOXL`
- overall_status: **OK**
...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| dprime_all_features_3scale | stepE_daily_log_dprime_all_features_3scale_SOXL.csv | 63 | 1.3880 | -0.3781 | 0.0089 | 0.0746 | 1.8887 |  | OK |
| dprime_all_features_h01 | stepE_daily_log_dprime_all_features_h01_SOXL.csv | 63 | 0.9711 | -0.4524 | 0.0034 | 0.0772 | 0.7043 |  | OK |
| dprime_all_features_h02 | stepE_daily_log_dprime_all_features_h02_SOXL.csv | 63 | 1.2298 | -0.3558 | 0.0070 | 0.0757 | 1.4764 |  | OK |
| dprime_all_features_h03 | stepE_daily_log_dprime_all_features_h03_SOXL.csv | 63 | 1.4319 | -0.4456 | 0.0096 | 0.0770 | 1.9749 |  | OK |
| dprime_bnf_3scale | stepE_daily_log_dprime_bnf_3scale_SOXL.csv | 63 | 1.0582 | -0.3974 | 0.0051 | 0.0815 | 0.9924 |  | OK |
| dprime_bnf_h01 | stepE_daily_log_dprime_bnf_h01_SOXL.csv | 63 | 1.4914 | -0.3258 | 0.0083 | 0.0765 | 1.7159 |  | OK |
| dprime_bnf_h02 | stepE_daily_log_dprime_bnf_h02_SOXL.csv | 63 | 0.5576 | -0.5986 | -0.0055 | 0.0748 | -1.1773 |  | OK |
| dprime_mix_3scale | stepE_daily_log_dprime_mix_3scale_SOXL.csv | 63 | 1.9352 | -0.2462 | 0.0140 | 0.0769 | 2.8993 |  | OK |
| dprime_mix_h01 | stepE_daily_log_dprime_mix_h01_SOXL.csv | 63 | 0.8054 | -0.3654 | 0.0001 | 0.0735 | 0.0289 |  | OK |
| dprime_mix_h02 | stepE_daily_log_dprime_mix_h02_SOXL.csv | 63 | 1.2140 | -0.3946 | 0.0067 | 0.0734 | 1.4401 |  | OK |

## StepF table
| file | test_days | equity_multiple | max_dd | mean_ret | std_ret | sharpe | note | status |
|---|---:|---:|---:|---:|---:|---:|---|---|
| stepF_equity_marl_SOXL.csv | 63 | 1.5634 | -0.2191 | 0.0088 | 0.0551 | 2.5274 | Split missing: evaluated all rows as test | OK |

## Diversity
- status: **OK**
- summary: agent positions look diverse
- max_corr: 0.8425
- max_match_ratio: 0.7460
...
- [scatter_stepE_dd_vs_ret.png](./scatter_stepE_dd_vs_ret.png)
  - note: StepF_vs_best_StepE: StepF(1.5634) は best StepE(1.9352) に負けてる
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\gh22617360504_att1_sim_20260303_184740_01c3594\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 63,
  ...
  "dprime": {
    ...
    "details": {
      ...
      "searched": [
        "C:\\work\\apex_work\\runs\\gh22617360504_att1_sim_20260303_184740_01c3594\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\gh22617360504_att1_sim_20260303_184740_01c3594\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\gh22617360504_att1_sim_20260303_184740_01c3594\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
    ...
    "rows": [
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.387952375338659,
        "max_dd": -0.3780812225912551,
        "mean_ret": 0.00887918011238328,
        "std_ret": 0.07463052605538974,
        "sharpe": 1.8886723970897266,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.9711005467072215,
        "max_dd": -0.4524046082726394,
        "mean_ret": 0.003424630843862407,
        "std_ret": 0.0771908529658586,
        "sharpe": 0.7042846034414525,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.2297974817815478,
        "max_dd": -0.3558093538803959,
        "mean_ret": 0.007037828832073592,
        "std_ret": 0.07567096995233742,
        "sharpe": 1.476419150268739,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.4318783497078453,
        "max_dd": -0.4456075810589084,
        "mean_ret": 0.009585096135880565,
        "std_ret": 0.07704474841932529,
        "sharpe": 1.9749390728226535,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.0581790266866198,
        "max_dd": -0.3973641866994797,
        "mean_ret": 0.005092420331181806,
        "std_ret": 0.08145573225498354,
        "sharpe": 0.9924368042416267,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.4914243211314544,
        "max_dd": -0.3257926874994779,
        "mean_ret": 0.008270873468481984,
        "std_ret": 0.07651730351855067,
        "sharpe": 1.715900063120784,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.557645317828012,
        "max_dd": -0.5986222117374448,
        "mean_ret": -0.0055490873988093235,
        "std_ret": 0.07482273523469699,
        "sharpe": -1.1773030120772936,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.9352085398737384,
        "max_dd": -0.24615089615679253,
        "mean_ret": 0.014044803790553683,
        "std_ret": 0.0769005243821122,
        "sharpe": 2.8992565401397363,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.8053619925429654,
        "max_dd": -0.3653795987155938,
        "mean_ret": 0.00013389893864369277,
        "std_ret": 0.0735190993273341,
        "sharpe": 0.028911939540178268,
        "status": "OK"
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.214039995522512,
        "max_dd": -0.39455981237950677,
        "mean_ret": 0.006655838151831261,
        "std_ret": 0.07336848904633037,
        "sharpe": 1.4401026445007912,
        "status": "OK"
      }
    ]
  },
    ...
    "rows": [
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.563368099645689,
        "max_dd": -0.21907984073108955,
        "mean_ret": 0.008771559630716396,
        "std_ret": 0.05509405015154801,
        "sharpe": 2.5273907431977465,
        "status": "OK",
  ...
  "diversity": {
    "status": "OK",
    "summary": "agent positions look diverse",
    "max_corr": 0.8424524406447761,
    "max_match_ratio": 0.746031746031746,
    "pairs_over_0_9999": 0,
    "all_pairs": 45,
    "identical_all_agents": false
  },
  ...
  "plots": {
    ...
    "notes": [
      "StepF_vs_best_StepE: StepF(1.5634) は best StepE(1.9352) に負けてる"
    ]
  }
}
```
