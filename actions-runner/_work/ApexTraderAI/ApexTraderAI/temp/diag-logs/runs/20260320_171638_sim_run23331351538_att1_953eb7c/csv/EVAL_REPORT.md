...
|---|---|---:|---:|---:|---:|---|
| stepB_pred_close_mamba_SOXL.csv | Pred_Close_MAMBA | 1.0000 | 1.0000 | 4.7561 | 0.8870 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h01 | 1.0000 | 1.0000 | 3.3832 | 0.9245 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h01 | 1.0000 | 1.0000 | 44.4795 | 0.0750 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h05 | 1.0000 | 1.0000 | 5.9183 | 0.8359 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h05 | 1.0000 | 1.0000 | 42.3690 | 0.1702 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h10 | 1.0000 | 1.0000 | 6.9745 | 0.7286 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h10 | 1.0000 | 1.0000 | 43.6408 | -0.1553 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC_h20 | 1.0000 | 1.0000 | 12.0117 | 0.6124 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC_h20 | 1.0000 | 1.0000 | 40.9020 | 0.1091 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Pred_Close_MAMBA_PERIODIC | 1.0000 | 1.0000 | 3.3832 | 0.9245 | OK |
| stepB_pred_close_mamba_periodic_SOXL.csv | Delta_Close_pred_MAMBA_PERIODIC | 1.0000 | 1.0000 | 44.4795 | 0.0750 | OK |
| stepB_pred_time_all_SOXL.csv | Pred_Close_MAMBA | 1.0000 | 1.0000 | 4.7561 | 0.8870 | OK |

## StepE table
| agent | file | test_days | equity_multiple | max_dd | mean_ret | std_ret | sharpe | note | status |
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| dprime_all_features_3scale | stepE_daily_log_dprime_all_features_3scale_SOXL.csv | 63 | 1.5927 | -0.1952 | 0.0083 | 0.0620 | 2.1217 |  | OK |
| dprime_all_features_h01 | stepE_daily_log_dprime_all_features_h01_SOXL.csv | 63 | 1.4272 | -0.1143 | 0.0055 | 0.0275 | 3.1931 |  | OK |
| dprime_all_features_h02 | stepE_daily_log_dprime_all_features_h02_SOXL.csv | 63 | 1.3781 | -0.1200 | 0.0053 | 0.0237 | 3.5135 |  | OK |
| dprime_all_features_h03 | stepE_daily_log_dprime_all_features_h03_SOXL.csv | 63 | 1.6043 | -0.1964 | 0.0078 | 0.0508 | 2.4375 |  | OK |
| dprime_bnf_3scale | stepE_daily_log_dprime_bnf_3scale_SOXL.csv | 63 | 1.0756 | -0.2604 | 0.0023 | 0.0608 | 0.5889 |  | OK |
| dprime_bnf_h01 | stepE_daily_log_dprime_bnf_h01_SOXL.csv | 63 | 1.0274 | -0.0942 | 0.0006 | 0.0157 | 0.5579 |  | OK |
| dprime_bnf_h02 | stepE_daily_log_dprime_bnf_h02_SOXL.csv | 63 | 0.8150 | -0.3261 | -0.0022 | 0.0458 | -0.7761 |  | OK |
| dprime_mix_3scale | stepE_daily_log_dprime_mix_3scale_SOXL.csv | 63 | 1.0664 | -0.3502 | 0.0024 | 0.0611 | 0.6198 |  | OK |
| dprime_mix_h01 | stepE_daily_log_dprime_mix_h01_SOXL.csv | 63 | 0.8720 | -0.2303 | -0.0016 | 0.0330 | -0.7533 |  | OK |
| dprime_mix_h02 | stepE_daily_log_dprime_mix_h02_SOXL.csv | 63 | 0.9457 | -0.1580 | -0.0004 | 0.0265 | -0.2493 |  | OK |
...
```json
{
    ...
    "rows": [
      {
        ...
        "mae": 4.7561240120539585,
        "corr": 0.887017452301544,
        "status": "OK"
      },
      {
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 3.3831536132722424,
        "corr": 0.9244610620408337,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 44.47952640515898,
        "corr": 0.07500520968145168,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 5.918301975687789,
        "corr": 0.8359096370827986,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 42.3690407559373,
        "corr": 0.17020293482266186,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 6.974506365190807,
        "corr": 0.72863059587166,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 43.640763804366905,
        "corr": -0.1553485030609114,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 12.011726828213307,
        "corr": 0.612441916457627,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
        ...
        "first_valid_date": "2022-01-03",
        "coverage_ratio_over_test": 1.0,
        "mae": 40.90200951712871,
        "corr": 0.10913265394563781,
        "status": "OK"
      },
      {
        "file": "stepB_pred_close_mamba_periodic_SOXL.csv",
    ...
    "rows": [
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.5926871547147654,
        "max_dd": -0.19518158137404618,
        "mean_ret": 0.008283134341831602,
        "std_ret": 0.0619741945962776,
        "sharpe": 2.121700525909673,
        "split_source": "csv",
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.427161337362796,
        "max_dd": -0.1142754760624245,
        "mean_ret": 0.005539731010163491,
        "std_ret": 0.027541095404875864,
        "sharpe": 3.19306484385303,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.378054651219153,
        "max_dd": -0.12002811420507564,
        "mean_ret": 0.005255155191473542,
        "std_ret": 0.02374329688286043,
        "sharpe": 3.5135391195969348,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.6042768415367923,
        "max_dd": -0.19642137921859038,
        "mean_ret": 0.0077988583094408355,
        "std_ret": 0.050791298394181644,
        "sharpe": 2.437485189318227,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.0756418908617371,
        "max_dd": -0.26042957743014417,
        "mean_ret": 0.0022554978564157274,
        "std_ret": 0.06080414231672048,
        "sharpe": 0.5888565663468908,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.027360349901287,
        "max_dd": -0.09418813033753104,
        "mean_ret": 0.0005516431892448848,
        "std_ret": 0.015696245488406025,
        "sharpe": 0.5579082050911737,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.8149509044316466,
        "max_dd": -0.32608980108554064,
        "mean_ret": -0.0022368315797595423,
        "std_ret": 0.04575033827853976,
        "sharpe": -0.7761385345938098,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 1.0663690374285404,
        "max_dd": -0.35020398313903267,
        "mean_ret": 0.0023846504728931603,
        "std_ret": 0.061073574745417275,
        "sharpe": 0.6198286713742388,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.8719785171738228,
        "max_dd": -0.23026580040089828,
        "mean_ret": -0.0015640139448270262,
        "std_ret": 0.03295800860244885,
        "sharpe": -0.7533207473115251,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
      ...
      },
      {
        ...
        "test_days": 63,
        "equity_multiple": 0.9457239565459777,
        "max_dd": -0.15803230330494222,
        "mean_ret": -0.000416077291494476,
        "std_ret": 0.02649288287141866,
        "sharpe": -0.24931308038129688,
        "split_source": "csv",
        "split_col_present": true,
        "train_rows": 2014,
        "test_rows": 63,
  ...
  "diversity": {
    "status": "OK",
    "summary": "agent positions look diverse",
    "max_corr": 0.9098397756014878,
    "max_match_ratio": 0.1746031746031746,
    "pairs_over_0_9999": 0,
    "all_pairs": 45,
    "identical_all_agents": false
  },
