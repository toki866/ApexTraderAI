...
- StepF audit outputs now include router-side diagnostics such as cluster quality/usage audits, focus-regime deep audits, no-cluster baselines, soft-routing A/B, and fallback A/B artifacts under the StepF audit subtree.
