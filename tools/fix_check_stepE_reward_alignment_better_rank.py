# -*- coding: utf-8 -*-
"""Fix script: update tools/check_stepE_reward_alignment.py

- Improve ranking so the "Top match" selects the best correlation/mae/rmse candidate
  (not just the one with the largest n).
- Keeps the existing --tag behavior.

This script:
  1) makes a timestamped backup into ./old/
  2) overwrites ./tools/check_stepE_reward_alignment.py

Run:
  python tools/fix_check_stepE_reward_alignment_better_rank.py
"""
...
NEW_SOURCE = r"""#!/usr/bin/env python
# -*- coding: utf-8 -*-
\"\"\"
