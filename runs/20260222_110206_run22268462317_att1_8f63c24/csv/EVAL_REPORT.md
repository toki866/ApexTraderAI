...
- output_root: `C:\work\apex_work\runs\20260222_105949\output`
- mode: `sim`
- symbol: `SOXL`
...
- prices_test:
  ...
  - ohlcv_missing:
    ...
    - Close: 0
    - Volume: 0
- split_summary_path: C:\work\apex_work\runs\20260222_105949\output\stepA\sim\stepA_split_summary_SOXL.csv
...
- stepE_daily_log_mamba_SOXL.csv: rows=2076 status=OK
