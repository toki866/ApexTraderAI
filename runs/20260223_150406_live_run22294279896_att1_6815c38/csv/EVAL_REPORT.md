...
- output_root: `C:\work\apex_work\runs\20260223_143816\output`
- mode: `sim`
- symbol: `SOXL`
- overall_status: **OK**
...
|---|---|---:|---:|---:|---:|---|
| stepB_pred_close_mamba_SOXL.csv | Pred_Close_MAMBA | 0.9711 | 1.0000 | 4.4167 | 0.9116 | OK |
| stepB_pred_time_all_SOXL.csv | Pred_Close_MAMBA | 0.9711 | 1.0000 | 4.4167 | 0.9116 | OK |
...
|---|---:|---:|---:|---:|---:|---:|---|---|
| stepF_equity_marl_SOXL.csv | 62 | 0.5379 | -0.4845 | -0.0088 | 0.0518 | -2.7034 | Split missing: evaluated all rows as test | OK |
...
- [scatter_stepE_dd_vs_ret.png](./scatter_stepE_dd_vs_ret.png)
  - note: StepF_vs_best_StepE: StepF(0.5379) は best StepE(0.8054) に負けてる
...
```json
{
  ...
  "stepA": {
    ...
    "details": {
      "path": "C:\\work\\apex_work\\runs\\20260223_143816\\output\\stepA\\sim\\stepA_prices_test_SOXL.csv",
      "test_rows": 62,
  ...
  "dprime": {
    ...
    "details": {
      ...
      "searched": [
        "C:\\work\\apex_work\\runs\\20260223_143816\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_train.csv",
        "C:\\work\\apex_work\\runs\\20260223_143816\\output\\stepD_prime\\sim\\stepDprime_state_*_SOXL_test.csv",
        "C:\\work\\apex_work\\runs\\20260223_143816\\output\\stepD_prime\\sim\\embeddings\\stepDprime_*_SOXL_embeddings*.csv"
      ]
    }
  },
  "stepE": {
    ...
    "rows": [
      {
        ...
        "test_days": 62,
        "equity_multiple": 0.5378710749768222,
        "max_dd": -0.48445458604658354,
        "mean_ret": -0.008815578045605135,
        "std_ret": 0.05176518345322357,
        "sharpe": -2.703418662819351,
        "status": "OK",
  ...
  "plots": {
    ...
    "notes": [
      "StepF_vs_best_StepE: StepF(0.5379) は best StepE(0.8054) に負けてる"
    ]
  }
}
```
